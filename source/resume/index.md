...
- 邮箱: <a href="mailto:songjianet@gmail.com">songjianet@gmail.com</a>

## ZOOMICRO - 2019-01 至 2020-11

### AbloClouda

`AbloClouda`是 [unicloud](https://www.unicloud.com/) 的前身，它是一个融合了`PaaS`和`IaaS`平台，为用户提供了云计算、人工智能、数据库、负载管理、安全备份、物联网等基础设施服务与平台服务。
...
- [multi-function-table](https://www.npmjs.com/package/multi-function-table) 一个超过4600次下载量的多功能表格工具；
- [wechat-city-picker](https://www.npmjs.com/package/wechat-city-picker) 基于微信小程序原生的省市区三级联动插件，最高单周下载量为1506次，累计下载量超过4800次；
